...
from registros import views as views_registros #Importamos la nueva vista de app registros parapoder asignar las rutas de acceso a sus vistas
#Permite acceder a las variables MEDIA_URL y MEDIA_ROOT que
#almacena la ubicacion de nuestras imagenes
